...
public class TagDifferTest {
	...
	public void simpleTextAdd() throws Exception {
		final String oldText = "<p> This is a blue book</p>";
		final String newText = "<p> This is a big blue book</p>";
	...
	public void simpleTextRemove() throws Exception {
		final String oldText = "<p> This is a blue book</p>";
		final String newText = "<p> This is a book</p>";
	...
	public void simpleTextChange() throws Exception {
		final String oldText = "<p> This is a blue book</p>";
		final String newText = "<p> This is a green book</p>";
	...
	public void simpleAttributeAdd() throws Exception {
		final String oldText = "<p> This is a blue book</p>";
		final String newText = "<p id='sample'> This is a blue book</p>";
	...
	public void simpleTagAdd() throws Exception {
		final String oldText = "<p> This is a blue book</p>";
		final String newText = "<p> This is a <b>blue</b> book</p>";
	...
	public void twiceChangeText() throws Exception {
		final String oldText = "<p> This is a blue book</p>";
		final String newText = "<p> This is a red table</p>";
	...
	public void strangeOBException() throws Exception {
		final String oldText = "<p>hello</p>";
		final String newText = "<p>hello in the end</p><p>New</p>";
